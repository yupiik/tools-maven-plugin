...
@DefaultScoped
@HelperDocumentation("Converts the passed parameter to a JSON string.")
public class ToJson implements Helper {
    private final JsonMapper mapper;

    public ToJson(final JsonMapper mapper) {
        this.mapper = mapper;
    }
