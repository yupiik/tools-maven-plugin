...
* Links are not updated, so they still rely on the base you set in the plugin and use Asciidoctor style links until you explicitly use `link:` yourself,
...
* To look nice, you can need to tune the Confluence space CSS to import admonitions and codeblocks styling (can require some admin permissions).
