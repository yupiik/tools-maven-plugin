 ...
 * </ul>
 * <p>
 * It can optionally embed an in-browser documentation assistant (RAG chat), see {@link #llmChatEnabled}
 * and <a href="https://yupiik.io/tools-maven-plugin/minisite-llm.html">Minisite LLM Chat</a>.
 */
...
public class MiniSiteMojo extends BaseMojo {
     ...
     * same model and a local WebLLM model ({@link #llmModelId}) answers using the retrieved chunks.
     * <p>
     * See <a href="minisite-llm.html">Minisite LLM Chat</a> for the
     * build-time setup and a description of the underlying mechanism.
     * <p>
     * Requires the langchain4j-embeddings-all-minilm-l6-v2 dependency to be added as a plugin dependency
     * (it ships the embedding model used at build time); the build fails fast if it is missing:
     * <pre>
     *     <code><![CDATA[<dependency>
     ...
     * </pre>
     *
     * @see <a href="https://yupiik.io/tools-maven-plugin/minisite-llm.html">Minisite LLM Chat documentation</a>
     */
    @Parameter(property = "yupiik.minisite.llmChatEnabled", defaultValue = "false")
    protected boolean llmChatEnabled;

    /**
     * WebLLM model identifier for the chat.
     */
    @Parameter(property = "yupiik.minisite.llmModelId", defaultValue = "Llama-3.2-3B-Instruct-q4f16_1-MLC")
    ...
    /**
     * Should a 404.html be generated by default - useful for github pages for example.
     * If you want custom text just override this page - you don't even need to turn this false, if present we respect it.
     */
    @Parameter(property = "yupiik.minisite.createADefault404Page", defaultValue = "true")
    protected boolean createADefault404Page;
     ...
     * Logo url.
     */
    @Parameter(property = "yupiik.minisite.logo", defaultValue = "{{base}}/images/logo.svg")
    private String logo;
    ...
    protected MiniSiteConfiguration createMiniSiteConfiguration(final ClassLoader loader) {
        if (llmChatEnabled && getClass().getClassLoader().getResource("all-minilm-l6-v2.onnx") == null) {
            throw new IllegalStateException(
                    "LLM chat is enabled but the embedding model is not on the plugin classpath.\n" +
