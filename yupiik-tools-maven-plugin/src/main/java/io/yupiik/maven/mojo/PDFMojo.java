...
public class PDFMojo extends BaseMojo {
    ...
    /**
     * PDF rendering does not depend on the slides converters (reveal.js/bespoke),
     * so by default only the diagram and pdf (rouge theme) libraries are required.
     */
    @Override
    public List<String> requires() {
        return requires != null ? requires : List.of("global", "pdf");
    }
