...
The minisite default templates are rendered with a link:https://handlebarsjs.com/[handlebars]-like engine so they can be `.hb` files.
To customize the look and feel, read the xref:minisite-theme.adoc[Minisite Theme] dedicated page.
