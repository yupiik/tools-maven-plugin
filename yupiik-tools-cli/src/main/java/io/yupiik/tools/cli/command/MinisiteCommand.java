...
public final class MinisiteCommand {
    ...
    public static void minisite(@Option(value = "source", description = "Where the minisite sits in (input folder).") @Required final Path source,
                                ...
                                @Option(value = "logo", description = "Site logo.") @Default("{{base}}/images/logo.svg") final String logo,
                                ...
                                @Option(value = "templatePrefixes", description = "Template names for page 'prefixes' (top part of the page).") @Default("header.hb,menu.hb") final List<String> templatePrefixes,
                                @Option(value = "templateSuffixes", description = "Template names for page 'suffixes' (bottom part of the page).") @Default("footer-top.hb,footer-end.hb") final List<String> templateSuffixes,
